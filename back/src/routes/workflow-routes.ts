...
router.get("/all/:pid", auth, projectAuth, workflowController.getAllWorkflows);
...
router.get("/all/templates/:pid", auth, projectAuth, workflowController.getAllWorkflowsTemplates);

router.delete("/jobtemplate/:jid", auth, workflowController.deleteJobTemplate);
...
router.post("/create", auth, projectAuth, wTemplateController.createWorkflowTemplate);
